<template>
  <v-app>
    ...
    <v-app-bar app clipped-left color="primary" dark>
      ...
      <v-toolbar-title class="headline"> 구글인증 - 이메일 로그인 </v-toolbar-title>
      <v-spacer></v-spacer>
      ...
      <v-toolbar-items class="hidden-xs-only">
        ...
        <v-btn text @click="fnDoLogout" v-if="fnGetAuthStatus"> <v-icon left>mdi-arrow-right-bold-box-outline</v-icon>로그아웃 </v-btn>
      </v-toolbar-items>
    </v-app-bar>
    <v-main>
      <router-view />
